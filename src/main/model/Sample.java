...
public abstract class Sample {
    ...
    //EFFECTS: sets isOdourous to true if user inputs 'yes' or sets isOdourous to false if user inputs 'no'
    public void setIsSampleOdourous(Sample sample, String contaminated) throws YesOrNoInputException {
        if (contaminated.equals("yes")) {
            ...
            throw new YesOrNoInputException("Invalid response: 'yes' or 'no' is required.");
        }
    }
